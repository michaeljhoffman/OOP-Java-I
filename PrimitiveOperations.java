...
public class PrimitiveOperations {
       ...
       public static void main(String[] args) {
            int myInteger = 1110;
            double myDouble = 24.67;
        
            System.out.println(myInteger);
            System.out.println(myDouble);
            
            double myDouble2 = myInteger*myDouble;
            
            System.out.println(myDouble2);
            
            double myIntAsDouble = myInteger;
            ...
            char firstInitialUpper = (char) ((int)firstInitial + 32);
            System.out.println(firstInitialUpper);
       }
